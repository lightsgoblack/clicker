...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString ${VERSION:-1.0}" "$PL" 2>/dev/null || true
...
echo "Built dist/Clicker.app and dist/Clicker-mac-$ARCH.zip ($(du -h "dist/Clicker-mac-$ARCH.zip" | cut -f1))"
